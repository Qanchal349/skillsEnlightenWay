...
// cancel subscription --------------------> subscribed user 
export const cancelSubscription = catchAsyncError(async(req,res,next)=>{
   ...
   res.status(200).json({
     success:true,
     message: 
      refund ?  "Subscription cancelled , You will receive full refund within 7 days": "Subscription cancelled , No refund initiate as subscription was cancelled after 7 days "
   })
